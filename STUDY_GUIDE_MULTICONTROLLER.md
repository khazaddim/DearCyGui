...
```
dearcygui/
├── core.cpp          # Generated by Cython from core.pyx
├── handler.cpp       # Generated by Cython from handler.pyx
├── types.cpp         # Generated by Cython from types.pyx
└── ... 

.venv/Lib/site-packages/dearcygui/
├── dearcygui.cp314-win_amd64.pyd   # Compiled extension (THE binary)
└── ...
```
