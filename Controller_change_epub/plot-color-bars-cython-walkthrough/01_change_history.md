...
- Cython class added in practice at `dearcygui/plot.pyx:3045`
...
- New properties in `dearcygui/plot.pyx:3219` and `dearcygui/plot.pyx:3239`
- Draw-time normalized conversion in `dearcygui/plot.pyx:3251`
- Public stub updates in `dearcygui/core.pyi:33754`, `dearcygui/core.pyi:33789`, `dearcygui/core.pyi:33918`, and `dearcygui/core.pyi:33935`
...
3. `dearcygui/plot.pyx:3045`
4. `openspec/changes/add-plot-color-bars-normalized-mode/design.md:1`
5. `dearcygui/plot.pyx:3219`
6. `dearcygui/plot.pyx:3251`
